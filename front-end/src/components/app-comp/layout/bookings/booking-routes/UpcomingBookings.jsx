                  ...
                  <td className='px-4'>
                    <a className='' href="">
                      <div className= 'cursor-pointer py-4 text-gray-100'>
                        <div className='max-w-10/12 sm:max-w-56 text-sm font-medium leading-6 md:max-w-full' title='15 between First User and Jeff'> 15 between First User and Jeff</div>
                        <div className=' font-semibold text-sm'>
                          <div className=' inline-block'> You</div>
                          <span>{" "} and {" "}</span>
                          <a className='hover:text-blue-500' href="">Jeff</a>
                        </div>
                      </div>
                    </a>
                  </td>
