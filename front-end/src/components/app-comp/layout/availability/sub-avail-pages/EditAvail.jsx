            ...
            <div className="border-subtle mb-6 rounded-md border ">
              <div className="p-2 sm:p-4">
                {['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'].map(day => (
                  <div key={day} className="flex items-center gap-4 mb-4  min-h-[38px]">
                    <input type="checkbox" id={day} className="toggle toggle-sm" onChange={() => handleToggleChange(day)} />
                    <label htmlFor={day} className="w-1/4 text-sm font-medium text-emphasis">{day}</label>
